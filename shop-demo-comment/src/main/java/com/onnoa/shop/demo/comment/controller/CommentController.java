...
public class CommentController {
    ...
    public ResultBean videoAdd(@RequestBody @Valid ContentCommentsAddDto addDto) {
    ...
    public ResultBean getAvatarByUserId(@RequestBody @Valid ContentCommentsListDto listDto) {

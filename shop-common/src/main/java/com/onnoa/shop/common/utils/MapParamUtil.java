...
public class MapParamUtil {
    ...
    private static Logger LOGGER = LoggerFactory.getLogger(MapParamUtil.class);
                ...
                if (map.get(field.getName()) != null && !"".equals(map.get(field.getName()))
                    ...
                    if (cl.getName().equals("java.lang.Long") || cl.getName().equals("long")) {
                        ...
                        if (o instanceof java.lang.String) {
                            try {
                                field.set(obj, DateUtils.parseDate(String.valueOf(o), DateUtils.DATE_TIME_FORMAT));
                            }
                            catch (Exception e) {
                                field.set(obj, DateUtils.parseDate(String.valueOf(o), DateUtils.DATE_FORMAT));
                            }
     ...
     * @throws Exception
     */
    private static void doSetMethodValue(Method setMethod, Object setValue, Object desObject)

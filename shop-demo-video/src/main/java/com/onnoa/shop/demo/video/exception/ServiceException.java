...
public class ServiceException extends RuntimeException implements Serializable {
    ...
    public static final ServiceException TRANSACTION_ROLLBACK = new ServiceException(999900012, "事务回滚测试异常....");
...
//        this.msg = msg == null ? "" : msg;
    ...
    protected ServiceException(int code, String msg, boolean isRollback) {
        super(msg);
        this.code = code;
        this.msg = msg == null ? "" : msg;
     ...
     * @return
     */
    public ServiceException newInstance(boolean isRollback, String msg) {
        try {
            Class<?> clazz = this.getClass();
            Constructor<?> constructor;
            constructor = clazz.getDeclaredConstructor(new Class[]{int.class, String.class});
            constructor.setAccessible(true);
            ServiceException be;
            be = (ServiceException) constructor.newInstance(this.code, msg);
            be.isRollbackTrans = isRollback;
            return be;
        } catch (Exception e) {
            throw ServiceException.NEW_EXCEPTION_INSTANCE_FAILED.newInstance(true, "创建业务异常新实例失败" + e.toString());
        }
    }

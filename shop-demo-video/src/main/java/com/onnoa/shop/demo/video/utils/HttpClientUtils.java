...
public class HttpClientUtils {
	...
	public static String doGet(String url, Map<String, String> params, Map<String, String> headers) {
		return doGet(url, params, DefaultCharset, headers);
	}

	public static <T extends Object> String doPost(String url, Map<String, String> params, Map<String, String> headers) {
		return doPost(url, params, DefaultCharset ,headers);
	}
	...
	public static String doPost(String url, Map<String, String> params, String charset, Map<String, String> headers) {
		...
		HttpResult result = doPostReturnStateCode(url, params, charset, headers);
	...
	public static HttpResult doGetReturnStateCode(String url, Map<String, String> params, Map<String, String> headers) {
		return doGetReturnStateCode(url, params, DefaultCharset, headers);
	}

	public static HttpResult doPostReturnStateCode(String url, Map<String, String> params, Map<String, String> headers) {
		return doPostReturnStateCode(url, params, DefaultCharset, headers);
	}
